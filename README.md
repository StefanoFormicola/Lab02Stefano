# Pytest Lab[![](https://github.com/mikeizbicki/functional-python/workflows/tests/badge.svg)](https://github.com/StefanoFormicola/functional-python/actions?query=workflow%3Atests)
